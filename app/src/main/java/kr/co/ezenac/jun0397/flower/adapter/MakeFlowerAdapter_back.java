...
public class MakeFlowerAdapter_back extends PagerAdapter {
    ...
    public MakeFlowerAdapter_back(Context context, ArrayList<Flower> items) {
...
//        tx_flower_name.setText(items2.get(i).getFlower_name());
//        tx_flower_price.setText(items2.get(i).getFlower_price());
